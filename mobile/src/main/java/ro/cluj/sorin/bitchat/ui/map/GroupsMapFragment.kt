...
//    channelLocation.close()
    ...
    private val presenter: GroupsMapPresenter by inject()
    private var isMapReady = false
    private var user: User? = null
    private var googleMap: GoogleMap? = null
    private lateinit var mapView: MapView

    //FIXME refactor to stable coroutines API
    ...
    override fun showMap(googleMap: GoogleMap) {
        ...
        googleMap.apply {
            ...
            context?.let {
                ...
                moveCamera(CameraUpdateFactory.newLatLngZoom(myLocation?.toLatLng()
                        ?: LatLng(0.00, 0.00), DEFAULT_ZOOM))
